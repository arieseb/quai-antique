...
/**
 * @extends ServiceEntityRepository<BookingDate>
 *
...
class BookingDateRepository extends ServiceEntityRepository
{
    ...
    public function save(BookingDate $entity, bool $flush = false): void
    {
    ...
    public function remove(BookingDate $entity, bool $flush = false): void
    {
